...
namespace PrivateLessonMS.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            Json_Result result = new Json_Result();
            try
            {
                var loginresult = await SignInManager.PasswordSignInAsync(User.Identity.GetUserName(), OldPassword, false, shouldLockout: false);
                switch (loginresult)
                {
                    case SignInStatus.Success:
                        {
                    ...
                    default:
                        {
                            ...
                            result.MSG = "Your Old Password is not valid ";
                            break;
                        }
                }
