var BootstrapDatetimepicker = {
    init: function () {
        $("#m_datetimepicker_1").datetimepicker({ todayHighlight: !0, autoclose: !0, format: "yyyy.mm.dd hh:ii" }),
            ...
            $("#m_datetimepicker_8").datepicker({ todayHighlight: !0, autoclose: !0, format: "yyyy-mm-dd", pickerPosition: "bottom-left"}),
            $("#m_datetimepicker_8_modal").datepicker({ todayHighlight: !0, autoclose: !0, format: "yyyy-mm-dd", pickerPosition: "bottom-left" }),
            $("#m_datetimepicker_9").datepicker({ todayHighlight: !0, autoclose: !0, format: "yyyy-mm-dd", pickerPosition: "bottom-left" }),
            $("#m_datetimepicker_9_modal").datepicker({ todayHighlight: !0, autoclose: !0, format: "yyyy-mm-dd", pickerPosition: "bottom-left" })
    }
